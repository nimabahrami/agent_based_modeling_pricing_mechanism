"""
This script generates training data for the gap predictor model.
It creates a CSV file with three columns:
1. Date (with quarterly resolution)
2. Generation (calculated based on the agents' assets)
3. Demand (from model input data multiplied by number of agents)
